...
Because of the particular distribuation of *instrumentalness* it is interesting to plot an histogram that allows a closer look to the comparison of the two distribution. 
...
From this plot we can see that Hit songs has a level of instrumentalness that is almost 0 while only Flop songs shows value close to 1. Altready from this chart we can see that the probability of a song being a Hit decrease witht respect to the increas in the level of instrumentalness. 
